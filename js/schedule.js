...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let schedule = [

        {
            ...
            description:
                "An introductory session covering material structures, properties and engineering applications.",
...

        {
            ...
            description:
                "Interactive mathematics class covering important engineering calculations and problem solving.",
...

        {
            ...
            description:
                "Develop professional communication and technical presentation skills.",
...

        {
            ...
            description:
                "A practical session focused on casting processes, mould preparation and foundry operations.",
...

        {
            ...
            description:
                "Learn the techniques used to analyze and characterize engineering materials.",
...

        {
            ...
            description:
                "Career development, teamwork, leadership and professional workplace skills.",
