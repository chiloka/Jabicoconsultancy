...
======================================================
   ...
   When the backend is ready, the following functions
   should be replaced/connected to API requests:
   ...
   The frontend structure above is already designed
   so this migration can happen later without rebuilding
